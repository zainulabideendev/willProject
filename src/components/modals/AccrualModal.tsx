...
export function AccrualModal({ isOpen, onClose }: AccrualModalProps) {
          ...
          <div className="space-y-3 text-[#2D2D2D] text-sm">
            <div className="p-3 rounded-lg" style={{
              ...
              <ul className="space-y-2 text-[#2D2D2D]/80">
                <li>An accrual settlement clause will be included in your will</li>
                <li>This ensures that the surviving spouse's accrual claim is properly addressed</li>
                <li>The clause will be subject to review during the will finalization process</li>
              </ul>
            </div>

            <p className="text-[#2D2D2D]/60 text-xs">
              This is an important legal consideration that helps protect both spouses' financial interests.
            </p>
          </div>
