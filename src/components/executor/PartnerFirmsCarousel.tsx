...
export function PartnerFirmsCarousel({ profileId, onSelect, selectedFirmId }: PartnerFirmsCarouselProps) {
          ...
          <SwiperSlide key={firm.id}>
            ...
            >
              ...
              <button
                ...
                disabled={saving || hasManualExecutors}
                ...
                style={{
                  ...
                  color: 'white',
                  boxShadow: '6px 6px 12px #d1d1d1, -6px -6px 12px #ffffff',
                  opacity: (saving || hasManualExecutors) ? 0.5 : 1,
                  cursor: (saving || hasManualExecutors) ? 'not-allowed' : 'pointer'
                }}
              >
                {saving ? (
