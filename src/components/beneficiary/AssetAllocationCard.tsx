...
import { Car, Home, Laptop, Briefcase, Building2, Package, Loader2, PieChart as ChartPie, Eye, EyeOff } from 'lucide-react';
...
export function AssetAllocationCard({
  ...
  const [showChart, setShowChart] = React.useState(() => {
    const stored = localStorage.getItem(`chart-visibility-${asset.id}`);
  ...
  const handleToggleChart = () => {
    ...
    localStorage.setItem(`chart-visibility-${asset.id}`, String(newValue));
  };
  ...
  return (
    <div className="asset-card">
      <div className="asset-header">
        <div className="asset-icon w-8 h-8 rounded-lg">
      ...
      <div className="asset-content space-y-4">
        ...
        <div className="text-sm text-[#2D2D2D]/60 text-right mt-4">
