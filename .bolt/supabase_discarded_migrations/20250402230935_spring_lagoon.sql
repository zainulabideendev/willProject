/*
  # Fix delete_executor function transaction handling

  1. Changes
    - Remove explicit transaction handling from delete_executor function
    - Let Supabase handle the transaction automatically
...
-- Create function to delete executor with proper transaction handling
...
EXCEPTION
  WHEN others THEN
    ...
    RAISE NOTICE 'Error in delete_executor: %', SQLERRM;
    RAISE;
END;
$$;