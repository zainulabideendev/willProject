/*
  ...
  1. Changes
    - Clean up existing partner data from asset_allocations and residue_allocations
    - Delete partner beneficiaries
    - Remove partner-related columns from profiles table
    - Update valid_family_member_type constraint to only allow spouse and child
    - Drop all partner-related triggers and functions
...
-- Drop partner-related functions and triggers
