/*
  ...
  1. Changes
    - Add trigger function to handle automatic spouse allocations
    - Trigger allocates 50% of all assets and residue to spouse for marriages in community of property
    - Only triggers when adding a spouse beneficiary
    - Checks marriage property regime before allocating
