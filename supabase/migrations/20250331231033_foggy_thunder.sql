/*
  # Remove life partner fields from profiles table

  1. Changes
    - Clean up any existing partner data from asset_allocations and residue_allocations
    - Remove partner beneficiaries
    - Drop all partner-related columns from profiles table
    - Update beneficiary type constraint to only allow spouse and child
